...
CKPT_DIR="${CKPT_DIR:-/home/wangml71/lehome-challenge/lehome-challenge/outputs/train/xvla_four_types/checkpoints/20260330}"
...
GARMENT_TYPE="${GARMENT_TYPE:-top_short}"
